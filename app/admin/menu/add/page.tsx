...
import { addFood, FOOD_CATEGORIES, type AdditionalItem } from "@/lib/food-service"
...
export default function AddFoodPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Food Added",
        description: "The food item has been added to your menu",
      })
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <DirectImageUploader foodName={name || "new-food"} onImageUploaded={handleImageUploaded} />
                </div>
